...
module mb_design
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_coded_data " *) input [31:0]gpio_coded_data_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_decoded_data " *) output [31:0]gpio_decoded_data_tri_o;
  ...
  wire [31:0]axi_gpio_coded_data_GPIO_TRI_I;
  wire [31:0]axi_gpio_decoded_data_GPIO_TRI_O;
  ...
  assign axi_gpio_coded_data_GPIO_TRI_I = gpio_coded_data_tri_i[31:0];
  assign diff_clock_rtl_1_CLK_N = clock_clk_n;
  assign diff_clock_rtl_1_CLK_P = clock_clk_p;
  assign gpio_decoded_data_tri_o[31:0] = axi_gpio_decoded_data_GPIO_TRI_O;
  assign reset_rtl_0_1 = reset_n;
  assign reset_rtl_1 = reset;
  mb_design_RLC_decoder_IP_0_0 RLC_decoder_IP_0
  ...
  mb_design_axi_gpio_0_0 axi_gpio_coded_data
       (.gpio_io_i(axi_gpio_coded_data_GPIO_TRI_I),
  ...
  mb_design_axi_gpio_1_0 axi_gpio_decoded_data
       (.gpio_io_o(axi_gpio_decoded_data_GPIO_TRI_O),
        .s_axi_aclk(microblaze_0_Clk),
